...
# Задача 1 (Создание и вызов функций):
# Напиши функцию say_hello(), которая просто печатает "Привет!".
# Вызови её два раза.
# Что нужно сделать:
# Объяви функцию без параметров
# Внутри функции используй print()
# Вызови её два раза
...
# Следующая простая задача (№2):
# Напиши функцию greet(name), которая печатает "Привет, {name}!".
# Вызови её с разными именами, например: greet("Анна") и greet("Петя").
...
# Следующая простая задача (№3 - аргументы по умолчанию):
# Напиши функцию order(food, drink="чай"), которая:
# Печатает: "Заказ: {food} и {drink}"
# По умолчанию drink всегда "чай", если не указан другой напиток
# Проверь работу:
# order("бутерброд") → Должно вывести "Заказ: бутерброд и чай"
# order("пицца", "кола") → Должно вывести "Заказ: пицца и кола"

def order(food, drink="чай"):
    print(f"Заказ: {food} и {drink}")


order("бутерброд")
order("пицца", "кола")

# Следующая простая задача (№4 - возврат значений):
# Напиши функцию add(a, b), которая:
# Принимает два числа
# Возвращает их сумму (используй return, не print!)
# Проверь работу: сохрани результат в переменную и выведи её
...
# Следующая простая задача (№5 - декораторы):
# Напиши декоратор @repeat_twice, который заставляет функцию выполняться два раза. Пример:
# python
# @repeat_twice
# def greet(name):
#     print(f"Привет, {name}!")
